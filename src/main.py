...
import engine  # compression engine variants
import adaptive_pipeline  # health monitoring & adaptive control
import energy_aware_execution  # energy‑aware scheduling
import hardware_optimized_layers  # layer definitions
import distributed_framework  # cluster orchestrator
